...
function hmuGen(){
    ...
    var contacts = {
		...
		'k':['Ian Crawford','Morpheus'],
		'Ian Crawford':{
		    'include':['email','mobile'],
			'email':'ianc',
			'domain':'morpheustraining.co.uk',
			'mobile':'0#79#67#68#20#5#5'
		},
		'General':{
...
//			console.log(who);
			...
			if($.inArray('mailto',contacts[who].include) > -1){
				var mailto = $('<a>').attr({'href':'mailto:' + contacts[who].email + '@' + contacts[who].domain + '?Subject=Enquiry'}).text('Send Enquiry');
